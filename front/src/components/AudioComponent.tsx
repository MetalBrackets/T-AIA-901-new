  ...
  return (
      <div class="flex justify-around p-4 m-5">
          <input
              ...
              value={transcription() || ""}
              placeholder="Écoute en cours..."
              onInput={(e) => setTranscription(e.target.value)}  // Permettre de modifier la transcription
          />
          <button class="text-green-700 hover:text-white border
                ...
                dark:hover:bg-green-600 dark:focus:ring-green-800" onClick={startRecording}>
              <svg enable-background="new 0 0 141.732 141.732"
                   height="20px" id="Livello_1" version="1.1"
                   viewBox="0 0 141.732 141.732" width="20px"
                   xml:space="preserve" xmlns="http://www.w3.org/2000/svg"
                   xmlns:xlink="http://www.w3.org/1999/xlink"><g id="Livello_7">
                <path d="M91.192,59.623V21.946c0.043-0.534,0.068-1.073,0.068-1.618C91.262,9.102,82.161,0,70.935,0
          ...
          <button class="text-red-700 hover:text-white border
                ...
                dark:hover:bg-red-600 dark:focus:ring-red-900" onClick={stopRecording}>Stop
          </button>
      </div>
