...
from Utils.get_coordonates import load_station_data, get_coordinates

# Setup for accessing the new CSV file
file_path = os.path.join(os.path.dirname(__file__), '..', '..', 'data', 'gares-de-voyageurs.csv')
